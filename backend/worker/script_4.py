# Create the backend API gateway (Node.js Express)
import os

project_name = "Privacy-Aware-RAG"
api_index_content = """require('dotenv').config();
...
# Write API gateway index.js
with open(f"{project_name}/backend/api/index.js", "w") as f:
    f.write(api_index_content)

print("Created backend API gateway index.js")